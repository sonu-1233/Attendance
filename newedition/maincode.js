function createSalarySuggestionSheet() {
    var sheets = getSalarySheet.getSheets();  
      ...
      if (totalColumns > 0) {
        ...
        newSuggestSalarySheet.getRange(thirdRow, 3).setValue('Total Salary Last Month');
        ...
        newSuggestSalarySheet.getRange(thirdRow, 4).setValue('New Salary This Month');
        ...
        newSuggestSalarySheet.getRange(thirdRow, 6).setValue('OverTime Amount');
        ...
        let employeeMap = {};
          ...
          newSuggestSalarySheet.getRange(row, startCol + 2).setValue(totalSalaryLastMonth);
          ...
          newSuggestSalarySheet.getRange(row, startCol + 9).setValue(suggestTotalSalary);
        }
      }
  }